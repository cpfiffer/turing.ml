...
<html>
  <head>
    ...
    <link rel="canonical" href="/v0.14/assets/js/application.js">
    <link rel="alternate" type="application/rss+xml" title="Turing.jl" href="/v0.14/feed.xml">
    ...
    <script src="/v0.14/assets/js/modernizr.74668098.js"></script>
    <link rel="shortcut icon" href="/v0.14/assets/img/favicon.ico">
    <link rel="stylesheet" href="/v0.14/assets/css/main.css">
    <link rel="stylesheet" href="/v0.14/assets/css/palette.css">
    <link rel="stylesheet" href="/v0.14/assets/css/header.css">
    ...
    <header class=md-header data-md-component=header data-md-state=none>
        <nav class="md-header-nav md-grid">
            <div class=md-flex>
                ...
                <div class="md-flex__cell md-flex__cell--shrink">
                    <a class="md-header-nav__button md-logo" href="/v0.14/" title="Turing.jl">
                ...
                <div class="md-flex__cell md-flex__cell--shrink">
                  <div class="md-header-nav__source">
                    <a class="md-source" href="/v0.14/docs/using-turing/get-started" title="Get started">
                      Get Started
                    </a>
                  </div>
                </div>
                ...
                <div class="md-flex__cell md-flex__cell--shrink">
                    <div class="md-header-nav__source">
                      <a class="md-source" href="/v0.14/docs/using-turing/" title="View documentation">
                        Documentation
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="md-flex__cell md-flex__cell--shrink">
                      <div class="md-header-nav__source">
                        <a class="md-source" href="/v0.14/tutorials/" title="View tutorials">
                          Tutorials
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="md-flex__cell md-flex__cell--shrink">
                      <div class="md-header-nav__source">
                        <a class="md-source" href="/v0.14/news/" title="News">
                          News
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="md-flex__cell md-flex__cell--shrink">
                      <div class="md-header-nav__source">
                        <a class="md-source" href="/v0.14/team/" title="Team">
                          Team
                        </a>
                      </div>
                    </div>
    ...
    <div class="md-sidebar__inner">
      <nav class="md-nav md-nav--primary" data-md-level="0">
        ...
        <label class="md-nav__title md-nav__title--site">
            <a class="" href="/v0.14/" title="Turing.jl">
                    ...
                    <nav class="md-nav md-nav--secondary">
                      ...
                      <ul class="md-nav__list" data-md-scrollfix="">
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/using-turing/get-started"
                              id="pancakes-getting-started"
                              title="Getting Started">Getting Started</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/using-turing/quick-start"
                              id="pancakes-quick-start"
                              title="Quick Start">Quick Start</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/using-turing/guide"
                              id="pancakes-guide"
                              title="Guide">Guide</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/using-turing/advanced"
                              id="pancakes-advanced-usage"
                              title="Advanced Usage">Advanced Usage</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/using-turing/autodiff"
                              id="pancakes-automatic-differentiation"
                              title="Automatic Differentiation">Automatic Differentiation</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/using-turing/performancetips"
                              id="pancakes-performance-tips"
                              title="Performance Tips">Performance Tips</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/using-turing/dynamichmc"
                              id="pancakes-using-dynamichmc"
                              title="Using DynamicHMC">Using DynamicHMC</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/using-turing/sampler-viz"
                  ...
                  <li class="md-nav__item md-nav__item--nested navbar_bottom-border">
                    ...
                    <nav class="md-nav md-nav--secondary">
                      ...
                      <ul class="md-nav__list" data-md-scrollfix="">
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/for-developers/compiler"
                              id="pancakes-turing-compiler-design"
                              title="Turing Compiler Design">Turing Compiler Design</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/for-developers/interface"
                              id="pancakes-interface-guide"
                              title="Interface Guide">Interface Guide</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/for-developers/how_turing_implements_abstractmcmc"
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/for-developers/variational_inference"
                  ...
                  <li class="md-nav__item md-nav__item--nested navbar_bottom-border">
                    ...
                    <nav class="md-nav md-nav--secondary">
                      ...
                      <ul class="md-nav__list" data-md-scrollfix="">
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/library"
                              id="pancakes-turing"
                              title="Turing">Turing</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/library/advancedhmc/"
                              id="pancakes-advancedhmc"
                              title="AdvancedHMC">AdvancedHMC</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/library/bijectors/"
                  ...
                  <li class="md-nav__item md-nav__item--nested navbar_bottom-border">
                    ...
                    <nav class="md-nav md-nav--secondary">
                      ...
                      <ul class="md-nav__list" data-md-scrollfix="">
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/contributing/guide"
                              id="pancakes-how-to-contribute"
                              title="How to Contribute">How to Contribute</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/v0.14/docs/contributing/style-guide"
             ...
             <a class="md-nav__link pancakes-parent "
                ...
                <nav class="md-nav">
                    <ul class="md-nav__list">
                        ...
                        <a href="/v0.14/docs/using-turing/get-started"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/using-turing/quick-start"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/using-turing/guide"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/using-turing/advanced"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/using-turing/autodiff"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/using-turing/performancetips"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/using-turing/dynamichmc"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/using-turing/sampler-viz"
             ...
             <a class="md-nav__link pancakes-parent "
                ...
                <nav class="md-nav">
                    <ul class="md-nav__list">
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/for-developers/compiler"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/for-developers/interface"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/for-developers/how_turing_implements_abstractmcmc"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/for-developers/variational_inference"
             ...
             <a class="md-nav__link pancakes-parent "
                ...
                <nav class="md-nav">
                    <ul class="md-nav__list">
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/0-introduction"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/1-gaussianmixturemodel"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/2-logisticregression"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/3-bayesnn"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/4-bayeshmm"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/5-linearregression"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/6-infinitemixturemodel"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/7-poissonregression"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/8-multinomiallogisticregression"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/9-variationalinference"
                           title="Variational Inference" style="display:none;"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/tutorials/10-bayesiandiffeq"
             ...
             <a class="md-nav__link pancakes-parent "
                ...
                <nav class="md-nav">
                    <ul class="md-nav__list">
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/library/advancedhmc/"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/library/bijectors/"
             ...
             <a class="md-nav__link pancakes-parent "
                ...
                <nav class="md-nav">
                    <ul class="md-nav__list">
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/contributing/guide"
                        ...
                        <li class="md-nav__item">
                        <a href="/v0.14/docs/contributing/style-guide"
    ...
    (function(e) {
        ...
        function i(t) {
            ...
            Array.prototype.forEach.call(n, function(e) {
                    ...
                    return fetch("/v0.14/search/search_index.json", {
...
© 2020 under the terms of the <a style="color:inherit; text-decoration: underline;" href="https://github.com/TuringLang/Turing.jl/blob/master/LICENCE">MIT License</a>.
    ...
    <script src="/v0.14/assets/js/application.js"></script>
    
    <script>console.log('4')</script>
    <script>app.initialize({version:"0.17.4", url:{base:'/v0.14'}})</script>

    
    <script src="/v0.14/assets/js/version-switch.js"></script>
