...
<html>
  <head>
    ...
    <link rel="canonical" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/assets/js/application.js">
    <link rel="alternate" type="application/rss+xml" title="Turing.jl" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/feed.xml">
    ...
    <script src="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/assets/js/modernizr.74668098.js"></script>
    <link rel="shortcut icon" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/assets/img/favicon.ico">
    <link rel="stylesheet" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/assets/css/main.css">
    <link rel="stylesheet" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/assets/css/palette.css">
    <link rel="stylesheet" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/assets/css/header.css">
    ...
    <header class=md-header data-md-component=header data-md-state=none>
        <nav class="md-header-nav md-grid">
            <div class=md-flex>
                ...
                <div class="md-flex__cell md-flex__cell--shrink">
                    <a class="md-header-nav__button md-logo" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/" title="Turing.jl">
                ...
                <div class="md-flex__cell md-flex__cell--shrink">
                  <div class="md-header-nav__source">
                    <a class="md-source" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/get-started" title="Get started">
                      Get Started
                    </a>
                  </div>
                </div>
                ...
                <div class="md-flex__cell md-flex__cell--shrink">
                    <div class="md-header-nav__source">
                      <a class="md-source" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/" title="View documentation">
                        Documentation
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="md-flex__cell md-flex__cell--shrink">
                      <div class="md-header-nav__source">
                        <a class="md-source" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/" title="View tutorials">
                          Tutorials
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="md-flex__cell md-flex__cell--shrink">
                      <div class="md-header-nav__source">
                        <a class="md-source" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/news/" title="News">
                          News
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="md-flex__cell md-flex__cell--shrink">
                      <div class="md-header-nav__source">
                        <a class="md-source" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/team/" title="Team">
                          Team
                        </a>
                      </div>
                    </div>
    ...
    <div class="md-sidebar__inner">
      <nav class="md-nav md-nav--primary" data-md-level="0">
        ...
        <label class="md-nav__title md-nav__title--site">
            <a class="" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/" title="Turing.jl">
                    ...
                    <nav class="md-nav md-nav--secondary">
                      ...
                      <ul class="md-nav__list" data-md-scrollfix="">
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/get-started"
                              id="pancakes-getting-started"
                              title="Getting Started">Getting Started</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/quick-start"
                              id="pancakes-quick-start"
                              title="Quick Start">Quick Start</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/guide"
                              id="pancakes-guide"
                              title="Guide">Guide</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/advanced"
                              id="pancakes-advanced-usage"
                              title="Advanced Usage">Advanced Usage</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/autodiff"
                              id="pancakes-automatic-differentiation"
                              title="Automatic Differentiation">Automatic Differentiation</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/performancetips"
                              id="pancakes-performance-tips"
                              title="Performance Tips">Performance Tips</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/dynamichmc"
                              id="pancakes-using-dynamichmc"
                              title="Using DynamicHMC">Using DynamicHMC</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/sampler-viz"
                  ...
                  <li class="md-nav__item md-nav__item--nested navbar_bottom-border">
                    ...
                    <nav class="md-nav md-nav--secondary">
                      ...
                      <ul class="md-nav__list" data-md-scrollfix="">
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/for-developers/compiler"
                              id="pancakes-turing-compiler-design"
                              title="Turing Compiler Design">Turing Compiler Design</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/for-developers/interface"
                              id="pancakes-interface-guide"
                              title="Interface Guide">Interface Guide</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/for-developers/how_turing_implements_abstractmcmc"
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/for-developers/variational_inference"
                  ...
                  <li class="md-nav__item md-nav__item--nested navbar_bottom-border">
                    ...
                    <nav class="md-nav md-nav--secondary">
                      ...
                      <ul class="md-nav__list" data-md-scrollfix="">
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials"
                              id="pancakes-home"
                              title="Home">Home</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/0-introduction"
                              id="pancakes-introduction-to-turing"
                              title="Introduction to Turing">Introduction to Turing</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/1-gaussianmixturemodel"
                              id="pancakes-gaussian-mixture-models"
                              title="Gaussian Mixture Models">Gaussian Mixture Models</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/2-logisticregression"
                              id="pancakes-bayesian-logistic-regression"
                              title="Bayesian Logistic Regression">Bayesian Logistic Regression</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/3-bayesnn"
                              id="pancakes-bayesian-neural-networks"
                              title="Bayesian Neural Networks">Bayesian Neural Networks</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/4-bayeshmm"
                              id="pancakes-hidden-markov-models"
                              title="Hidden Markov Models">Hidden Markov Models</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/5-linearregression"
                              id="pancakes-linear-regression"
                              title="Linear Regression">Linear Regression</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/6-infinitemixturemodel"
                              id="pancakes-infinite-mixture-models"
                              title="Infinite Mixture Models">Infinite Mixture Models</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/7-poissonregression"
                              id="pancakes-bayesian-poisson-regression"
                              title="Bayesian Poisson Regression">Bayesian Poisson Regression</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/8-multinomiallogisticregression"
                              id="pancakes-multinomial-logistic-regression"
                              title="Multinomial Logistic Regression">Multinomial Logistic Regression</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/9-variationalinference"
                              id="pancakes-variational-inference"
                              title="Variational Inference">Variational Inference</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/10-bayesiandiffeq"
                  ...
                  <li class="md-nav__item md-nav__item--nested navbar_bottom-border">
                    ...
                    <nav class="md-nav md-nav--secondary">
                      ...
                      <ul class="md-nav__list" data-md-scrollfix="">
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/library"
                              id="pancakes-turing"
                              title="Turing">Turing</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/library/advancedhmc/"
                              id="pancakes-advancedhmc"
                              title="AdvancedHMC">AdvancedHMC</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/library/bijectors/"
                  ...
                  <li class="md-nav__item md-nav__item--nested navbar_bottom-border">
                    ...
                    <nav class="md-nav md-nav--secondary">
                      ...
                      <ul class="md-nav__list" data-md-scrollfix="">
                        ...
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/contributing/guide"
                              id="pancakes-how-to-contribute"
                              title="How to Contribute">How to Contribute</a>
                        </li>
                        
                        <li class="md-nav__item navbar_bottom-border">
                          <a class="md-nav__link" href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/contributing/style-guide"
             ...
             <a class="md-nav__link pancakes-parent "
                ...
                <nav class="md-nav">
                    <ul class="md-nav__list">
                        ...
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/get-started"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/quick-start"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/guide"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/advanced"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/autodiff"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/performancetips"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/dynamichmc"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/using-turing/sampler-viz"
             ...
             <a class="md-nav__link pancakes-parent "
                ...
                <nav class="md-nav">
                    <ul class="md-nav__list">
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/for-developers/compiler"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/for-developers/interface"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/for-developers/how_turing_implements_abstractmcmc"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/for-developers/variational_inference"
             ...
             <a class="md-nav__link pancakes-parent "
                ...
                <nav class="md-nav">
                    <ul class="md-nav__list">
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/0-introduction"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/1-gaussianmixturemodel"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/2-logisticregression"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/3-bayesnn"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/4-bayeshmm"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/5-linearregression"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/6-infinitemixturemodel"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/7-poissonregression"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/8-multinomiallogisticregression"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/9-variationalinference"
                           title="Variational Inference" style="display:none;"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/tutorials/10-bayesiandiffeq"
             ...
             <a class="md-nav__link pancakes-parent "
                ...
                <nav class="md-nav">
                    <ul class="md-nav__list">
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/library"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/library/advancedhmc/"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/library/bijectors/"
             ...
             <a class="md-nav__link pancakes-parent "
                ...
                <nav class="md-nav">
                    <ul class="md-nav__list">
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/contributing/guide"
                        ...
                        <li class="md-nav__item">
                        <a href="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/docs/contributing/style-guide"
    ...
    (function(e) {
        ...
        function i(t) {
            ...
            Array.prototype.forEach.call(n, function(e) {
                    ...
                    return fetch("/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/search/search_index.json", {
...
© 2020 under the terms of the <a style="color:inherit; text-decoration: underline;" href="https://github.com/TuringLang/Turing.jl/blob/master/LICENCE">MIT License</a>.
    ...
    <script src="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/assets/js/application.js"></script>
    
    <script>console.log('4')</script>
    <script>app.initialize({version:"0.17.4", url:{base:'/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)'}})</script>

    
    <script src="/turing.ml/$(git -C ~/.julia/dev/Turing tag --sort version:refname | tail -n 1)/assets/js/version-switch.js"></script>
